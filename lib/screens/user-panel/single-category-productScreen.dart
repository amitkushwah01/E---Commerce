...
class AllSingleCategoryProductScreen extends StatefulWidget
{
  ...
  AllSingleCategoryProductScreen({
    super.key , required this.categoriesId,
  });
  @override
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      FutureBuilder(
        ...
        .collection('products')
        .where('categoriesId',isEqualTo: widget.categoriesId)
        .get(),
                      ...
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          FillImageCard(
                            ...
                            title: Center(child: Text(productModel.productName,style: TextStyle(fontSize: 12),)),
                          ),
                        ),
                      ),
                    )
